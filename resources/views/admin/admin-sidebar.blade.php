<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('admin.body')}}">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('show.product')}}">add product</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('products')}}">show product</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item menu-items">
